...
wget https://launcher.mojang.com/v1/objects/1b9c8e5a0f2c3e5b8d9e7a4c8b6e5f1a2b3c4d/server.jar -O minecraft_server.jar

# Accept the EULA by creating a file named eula.txt with the content "eula=true"
echo "eula=true" > eula.txt

# Install screen to allow the Minecraft server to run in the background
